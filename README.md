...
- [Highload Instagram](#highload-instagram)
  ...
  - [Тема и целевая аудитория](#тема-и-целевая-аудитория)
    - [Факты про целевую аудиторию](#факты-про-целевую-аудиторию)
  ...
  - [Схема проекта](#схема-проекта)
    - [Описание](#описание)
    - [Логика формирования ленты](#логика-формирования-ленты)
    - [Логический план запроса](#логический-план-запроса)
  - [Список серверов](#список-серверов)
    - [Балансировщики](#балансировщики)
    - [Бэкенды (API Gateway)](#бэкенды-api-gateway)
