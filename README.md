...
С момента запуска приложения было насчитано около 50 миллиардов фотографий [[3]](<https://earthweb.com/how-many-pictures-are-on-instagram/>), в секунду загружается 1 074 фотографий. Значит, возьмем 3/4 постов с фотографией и 1/4 с видео и посчитаем приблизительный суммарный размер базы, которая будет хранить все посты:
...
2. [Количество пользователей](https://www.statista.com/statistics/183585/instagram-number-of-global-users/)
3. [Количество постов](https://earthweb.com/how-many-pictures-are-on-instagram/)
4. [Шардирование](https://habr.com/ru/companies/oleg-bunin/articles/433370/)
5. [Nginx нагрузка](https://www.nginx.com/blog/testing-the-performance-of-nginx-and-nginx-plus-web-servers/)
