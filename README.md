...
|-------------- | -------------------- | -------------- |
| Golang        | Backend dev          | Популярный, быстрый, читаемый, поддерживающий многопоточную и асинхронную работу язык. За счет своей опулярности имеет иножество готовых решений для backend-разработки |
|-------------- | -------------------- | -------------- |
