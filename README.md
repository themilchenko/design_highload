...
> 0.25 x 500 000 000 x (1 + 2 + 3 + 4) = 1 250 000 000
...
- Информация о пользователе
  ...
  > 1 350 000 000 x 4 = 5.4 * 10^9 Мб = 5 400 Тб ~= 5.4 Пб.
...
- Размер постов
    ...
    С момента запуска приложения было насчитано около 50 миллиардов фотографий [[6]](<https://earthweb.com/how-many-pictures-are-on-instagram/>), в секунду загружается 1 074 фотографий. Значит, возьмем 3/4 постов с фотографией и 1/4 с видео и посчитаем приблизительный суммарный размер базы, которая будет хранить все посты:
...
> [1 250 000 000 (в день) x 60 (кол-во просмотренных постов) x (0.75 x 2.2 + 0.25 x 8.2)] / (24 x 3 600) = 3 211 805 Мб/с = 25 092 Гбит/с

Для пиковой нагрузки умножу показатель в 2 раза:

> 25 092 Гбит/с x 2 = 50 184 Гб/с
...
Суточная нагрузка на сеть - `3 151 Гб * 3600 * 24 = 272 246 400 Гб/сутки`
...
| Просмотр ленты            | 14 467                               | 28 934                |
| **Итого**                 | **44 941**                           | **108 120**           |
...
5. [Битрейт видео](https://www.puckermob.com/tech/everything-you-wanted-to-know-about-best-bitrate-for-instagram/)
6. [Количество постов](https://earthweb.com/how-many-pictures-are-on-instagram/)
7. [Шардирование](https://habr.com/ru/companies/oleg-bunin/articles/433370/)
